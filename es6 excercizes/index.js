...
// Fix the code so that when i is declared in the if statement is a separate variable than i declared in the first line of the function. Be certain not to use the var keyword anywhere in your code.
...
let temp - thermos.temperature =26;
...
import * as string_functions from './string_functions.js';
...
const makeServerRequest = new Promise((resolve, reject) => {
    ...
    reject("Data not recieved");  // Change this line
    }
  });
